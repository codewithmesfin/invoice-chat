      ...
      <DialogContent className="flex max-h-[min(88dvh,640px)] flex-col gap-0 overflow-hidden p-0 sm:max-w-md">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
          {loading ? (
            ...
            <p className="px-5 py-12 text-center text-sm leading-relaxed text-muted-foreground">
                ...
                return (
                  <li key={s.id} className="flex items-stretch">
                    <button
                      type="button"
                      className={cn(
                        "min-h-[3.75rem] flex-1 px-4 py-3 text-left transition-colors touch-manipulation [-webkit-tap-highlight-color:transparent] active:bg-muted/80",
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <span className="min-w-0 flex-1">
                          ...
                          <span className="mt-0.5 block text-xs text-muted-foreground">{formatUpdated(s.updated_at)}</span>
                        </span>
                      </div>
                    </button>
                    <div className="flex shrink-0 flex-col border-l border-border/60 py-1 pr-2">
                      <Button
                        type="button"
                        variant="ghost"
                        size="icon"
